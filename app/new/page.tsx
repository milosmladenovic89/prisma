...
import { FilteredCoils } from "@/utils/action";
  ...
  return (
    <div className='h-80v flex justify-center items-center w-full'>
      ...
      <div className="h-full">
        ...
        <div className='w-70v h-75v border border-black' >
          ...
          <div className=' h-16 flex justify-end'>
            ...
            <button className='btn btn-primary m-1'>Next</button>
            <button className='btn btn-primary m-1'>Finish</button>
          </div>
